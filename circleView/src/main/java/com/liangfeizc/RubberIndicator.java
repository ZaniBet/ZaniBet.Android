...
public class RubberIndicator extends RelativeLayout {
    ...
    private static final int DEFAULT_SMALL_CIRCLE_COLOR = 0xFF66BB6A;
    private static final int DEFAULT_LARGE_CIRCLE_COLOR = 0xFF4CAF50;
    private static final int DEFAULT_OUTER_CIRCLE_COLOR = 0xFF66BB6A;

    private static final int SMALL_CIRCLE_RADIUS = 20;
    private static final int LARGE_CIRCLE_RADIUS = 20;
