...
public class GrilleSinglePlayedPresenter implements GrilleSinglePlayedContract.Presenter {

    private GrilleSinglePlayedContract.View mView;
    private Context mContext;
    private GrilleService mGrilleService;

    public GrilleSinglePlayedPresenter(GrilleSinglePlayedContract.View view, Context context){
        mView = view;
        mContext = context;
    ...
    public void loadGrille(GameTicket gameTicket) {
        ...
        mGrilleService.getSingleGrille(gameTicket.getId())
